...
@section('main')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Data Kas Masuk</li>
        </ol>
    </div>
            ...
            <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <div class="mb-6 d-flex justify-content-end">
                        <a href="/kasmasuk-create" class="btn btn-primary">Tambah Data</a>
                    </div>
                </div>
                        ...
                        <tbody>
                            ...
                            @foreach ($kasMasuk as $masuk)
                                <tr>
                                    ...
                                    <td>
                                        <a href="/kasmasuk-edit-{{ $masuk->id }}" class="btn btn-sm btn-warning">Edit</a>
                                        <form action="/kasmasuk-delete-{{ $masuk->id }}" method="POST" style="display:inline;">
                                            @csrf
                                            @method('DELETE')
