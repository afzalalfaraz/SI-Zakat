        ...
        <div class="main_menu">
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <li class="nav-item <?php echo $_SERVER['REQUEST_URI'] == '/visimisi' ? 'active' : ''; ?>">
                    <a class="nav-link" href="/visimisi">Kas</a>
                </li>
                <li class="nav-item <?php echo $_SERVER['REQUEST_URI'] == '/kontak' ? 'active' : ''; ?>">
                    <a class="nav-link" href="#kontak">Pembayaran</a>
                        ...
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item <?= $current_page == 'visimisi' ? 'active' : '' ?>">
                                <a class="nav-link" href="/visimisi">Kas</a>
                            </li>
                            <li class="nav-item <?= $current_page == 'pembayaran' ? 'active' : '' ?>">
