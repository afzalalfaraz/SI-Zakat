              ...
              <div class="col-lg-12">
                <div class="banner_content text-center">
                  <p class="text-uppercase">
                    <style>
                      .quote-bubble {
                          background-color: rgba(245, 245, 245, 0.7); /* Transparansi 70% */
                      ...
                      .quote-bubble h3 {
                          ...
                          margin: 10px 0; /* Margin antar judul */
                      }
              ...
              <body>
                  <div class="container">
                      <div class="quote-bubble"> <!-- Gelembung untuk menampung konten -->
                          ...
                          <h3 class="text-uppercase mt-4 mb-5">خُذْ مِنْ أَمْوَٰلِهِمْ صَدَقَةً تُطَهِّرُهُمْ وَتُزَكِّيهِم بِهَا وَصَلِّ عَلَيْهِمْ ۖ إِنَّ صَلَوٰتَكَ سَكَنٌ لَّهُمْ ۗ وَٱللَّهُ سَمِيعٌ عَلِيمٌ</h3>
                          <h3>"Ambillah zakat dari sebagian harta mereka, dengan zakat itu kamu membersihkan dan mensucikan mereka dan berdoalah untuk mereka. Sesungguhnya doa kamu itu (menjadi) ketenteraman jiwa bagi mereka. Dan Allah Maha Mendengar lagi Maha Mengetahui."</h3>
                          <h3>(At-Taubah: 103)</h3>
                      </div>
                  </div>
                ...
                <div class="col-lg-4 col-md-6" style="display: flex; justify-content: center;"> <!-- Menggunakan Flexbox -->
                    <div class="single_feature" style="text-align: center;"> <!-- Menyesuaikan elemen -->
                        ...
                        <div class="desc">
                            ...
                            <p>
                                Menjadi pusat informasi dan sarana pengelolaan zakat, infaq, dan sedekah yang terpercaya serta menyediakan platform yang memudahkan umat dalam berkontribusi untuk kesejahteraan umat melalui pembangunan masjid dan pemberdayaan masyarakat.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6" style="display: flex; justify-content: center;"> <!-- Menggunakan Flexbox -->
                    <div class="single_feature" style="text-align: center;"> <!-- Menyesuaikan elemen -->
                        <div class="desc">
                            ...
                            <p>
                                Menyediakan platform yang mudah digunakan untuk melakukan pembayaran zakat, infaq, dan sedekah secara online dengan transparansi dan keamanan yang tinggi.
                            </p>
                        </div>
                    </div>
                </div>
